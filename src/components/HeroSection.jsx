        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 text-center text-white pt-16 sm:pt-20">
          ...
          >
            ...
            <motion.p
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: .8 }}
              className="text-sm sm:text-base md:text-lg lg:text-xl mb-10 leading-relaxed text-emerald-100 max-w-3xl mx-auto"
            >
            ...
            >
              <a href="https://apps.apple.com/fr/app/clinique-des-plantes" target="_blank">
                <img
                  src="https://tools.applemediaservices.com/api/badges/download-on-the-app-store/black/fr-fr?size=250x83&releaseDate=1318032000"
                  alt="App Store"
                  className="h-12 sm:h-14 md:h-[64px]"
                />
              </a>
              <a href="https://play.google.com/store/apps/details?id=com.cliniquedesplantes" target="_blank">
                <img
                  ...
                  alt="Google Play"
                  className="h-[52px] sm:h-16 md:h-[72px]"
                />
              </a>
            </motion.div>
